                ...
                .addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                  ...
                  public void onComplete(@NonNull Task<AuthResult> task) {
                    if (task.isSuccessful()) {
                      ...
                      if(DevId.equals("00")){
                        Intent int3 = new Intent(MainActivity.this,navActivity.class);
                        int3.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                        int3.putExtra("Username",userName);
                        int3.putExtra("Mail",Email.getText().toString());
                        startActivity(int3);
                      }
                      else {
                        Toast.makeText(getApplicationContext(), "Login successful!", Toast.LENGTH_LONG).show();
                        pBar.setVisibility(View.GONE);
                        Intent int1 = new Intent(MainActivity.this, DashActivity.class);
                        int1.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                        int1.putExtra("Username", userName);
                        int1.putExtra("Mail", Email.getText().toString());
                        startActivity(int1);
                        finish();
                      }
                    }
